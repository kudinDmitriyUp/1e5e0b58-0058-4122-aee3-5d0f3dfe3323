...
export const metadata: Metadata = {
  title: "BrewHaven - Premium Local Coffee Shop",
  description: "Handcrafted specialty coffee from ethically sourced beans. Visit our cozy neighborhood coffee shop for expertly made drinks and fresh pastries.",
  keywords: "coffee shop, specialty coffee, local cafe, espresso, latte, barista, coffee beans",
  openGraph: {
    title: "BrewHaven Coffee Shop",
    description: "Experience premium specialty coffee in our welcoming neighborhood cafe",
    siteName: "BrewHaven",
    type: "website"
  },
  robots: {
